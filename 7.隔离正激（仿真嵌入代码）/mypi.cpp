 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 23 13:15:44 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                mypi
...
extern void mypi_Start_wrapper(void);
extern void mypi_Outputs_wrapper(const real_T *u0,
  const real_T *u1,
  real_T *y0);
